...
const NewMovieForm = () => {
    ...
    const formSubmit = (formData) => {
        createMovie(formData).then((movie) => console.log(movie));
        navigate("/movies");
    };
    return (
        <form onSubmit={handleSubmit(formSubmit)} className={styles.form}>
            ...
            <div className={styles.field}>
                <label>Year</label>
                <input
                    className={errors.number ? styles.error_input : ""}
                    type="number"
                    {...register("year")}
                />
                <div className={styles.error_container}>
            ...
            <div className={styles.field}>
                <label>Image</label>
                <input
                    className={errors.image ? styles.error_input : ""}
                    type="text"
                    {...register("image")}
                />
                <div className={styles.error_container}>
            ...
            <div className={styles.field}>
                ...
                <input
                    className={errors.director ? styles.error_input : ""}
                    type="text"
                    {...register("director")}
                />
                <div className={styles.error_container}>
